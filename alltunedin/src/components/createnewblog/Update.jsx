...
const UpdateBlog=()=>{
    ...
    const updateBlog=async ()=>{
          const response = await API.updatePost(blog);
          if(response.isSuccess){
            navigate(`/details/${id}`);
          }
    }
        ...
        <Container>
            ...
            <StyledFormControl>
               <label htmlFor="fileInput">
                ...
                <Button variant="contained" onClick={(e)=>updateBlog(e)} >Update</Button>
            </StyledFormControl>
            <TextArea minRows={5} placeholder="Add your content...." onChange={(e)=>handleChange(e)} name="description" value={blog.description}/>
        </Container>
    )
}
